...
#' @param doc Optionally, an rJava reference to a PDDocument Java object.
...
#' @export
get_page_dims <- function(file, pages = NULL, password = NULL) {
...
#' @rdname get_page_dims
#' @export
get_n_pages <- function(doc, file, password = NULL) {
    if (!missing(file)) {
